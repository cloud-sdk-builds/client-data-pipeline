...
[`@aws-sdk/client-data-pipeline`](https://www.npmjs.com/package/@aws-sdk/client-data-pipeline/v/3.1097.0).
...
- @aws-sdk/client-data-pipeline - [https://cloud-sdk-builds.github.io/?sdk=client-data-pipeline](https://cloud-sdk-builds.github.io/?sdk=client-data-pipeline)
- @aws-sdk/client-data-pipeline v3.1097.0 - [https://cloud-sdk-builds.github.io/?sdk=client-data-pipeline&version=3.1097.0](https://cloud-sdk-builds.github.io/?sdk=client-data-pipeline&version=3.1097.0)
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-data-pipeline@3.1097.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-dInO33IMRNSYX4uIslr3R2g7OWecmgudi9IWg23xMs0aMOKUaO6HuxT6pJzdnsSG
```
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-data-pipeline/index.min.mjs
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-data-pipeline": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-data-pipeline@3.1097.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-data-pipeline@3.1097.0/index.min.mjs": "sha384-dInO33IMRNSYX4uIslr3R2g7OWecmgudi9IWg23xMs0aMOKUaO6HuxT6pJzdnsSG"
        }
      }
</script>
```
...
<html lang="en">
      ...
      <body>
            <h1>Hello World!</h1>
            <script type="module">
                  import {  } from "@aws-sdk/client-data-pipeline";
...
```
https://github.com/cloud-sdk-builds/client-data-pipeline/blob/refs/tags/3.1097.0/LICENSE
```
