...
[`@aws-sdk/client-data-pipeline`](https://www.npmjs.com/package/@aws-sdk/client-data-pipeline/v/3.981.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-data-pipeline@3.981.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ImNFth66wTTosQ26bTIHJMC/X/ApzqZYGrQ1qCBFBym3khpaK1Ki1CK5p0p+L++z
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-data-pipeline": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-data-pipeline@3.981.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-data-pipeline@3.981.0/index.min.mjs": "sha384-ImNFth66wTTosQ26bTIHJMC/X/ApzqZYGrQ1qCBFBym3khpaK1Ki1CK5p0p+L++z"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-data-pipeline/blob/refs/tags/3.981.0/LICENSE
```
